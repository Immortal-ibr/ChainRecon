...
from chainrecon.runners.base import check_tool, make_output_dir, run_subprocess
...
def _default_interface() -> Optional[str]:
    try:
        from chainrecon.utils.config import get_scan_config
        from chainrecon.utils.network import resolve_scan_interface

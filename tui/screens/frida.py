...
HELP_TEXT = """[bold underline]Frida Dynamic Instrumentation[/]
...
[bold]Setup Requirements[/]
  ...
  2. Download frida-server for your device arch from github.com/frida/frida/releases
  3. adb push frida-server /data/local/tmp/ && adb shell chmod +x /data/local/tmp/frida-server
